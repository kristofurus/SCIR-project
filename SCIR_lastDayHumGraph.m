...
[internet_hum, internet_times] = thingSpeakRead(internetChannel, 'Fields', 2, 'NumPoints', NUM_OF_HOURS, 'ReadKey', internetChannelReadKey);
...
% plot data
bar(times, internet_hum, "FaceAlpha",0.5);
hold on
